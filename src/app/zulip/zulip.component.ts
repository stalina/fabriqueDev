...
@Component({
  selector: 'app-zulip',
  templateUrl: './zulip.component.html',
  styleUrls: ['./zulip.component.css']
})
export class ZulipComponent extends ToolComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, config: NgbTabsetConfig, private checkToolsService: CheckToolsService,private identityService:IdentityService) {
    super(checkToolsService,identityService,Tools.ZULIP);
