...
@Component({
  ...
  styleUrls: ['./redmine.component.css']
})
export class RedmineComponent extends ToolComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, config: NgbTabsetConfig, private checkToolsService: CheckToolsService,private identityService:IdentityService) {
    super(checkToolsService,identityService,Tools.REDMINE);
